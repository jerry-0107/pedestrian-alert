...
export function Marquees() {
    ...
    return <> <Box sx={{ width: "100%", height: "100%", display: "flex" }}>
        ...
        <FullScreen handle={handle}>
            <Marquee style={{ userSelect: "none", maxWidth: "100vw", color: "#fff", background: "#000", fontSize: "13vw", width: "100%", height: "100%", verticalAlign: "center" }} speed={Number(UrlParam("s"))}>{UrlParam("q")}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</Marquee>
        </FullScreen>
